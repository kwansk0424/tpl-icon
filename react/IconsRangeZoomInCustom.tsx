...
const IconsRangeZoomInCustom = (
  ...
  >
    ...
    <g fill="currentColor" mask="url(#prefix__a)">
      ...
      <path d="m6.835 8.563.78.78q.219.225.222.544a.73.73 0 0 1-.221.543.74.74 0 0 1-.54.225.74.74 0 0 1-.54-.225l-2.1-2.092a.785.785 0 0 1-.17-.841.8.8 0 0 1 .17-.256L6.526 5.15a.73.73 0 0 1 .536-.225.76.76 0 0 1 .545.225q.232.224.232.543a.75.75 0 0 1-.232.552l-.764.764h10.173l-.772-.773a.76.76 0 0 1-.221-.543.72.72 0 0 1 .23-.543q.225-.225.54-.225t.54.225l2.092 2.091q.111.112.169.256a.79.79 0 0 1 0 .586.8.8 0 0 1-.17.255l-2.091 2.092a.73.73 0 0 1-.536.225.76.76 0 0 1-.544-.225.74.74 0 0 1-.237-.543.74.74 0 0 1 .228-.552l.772-.772zM13.72 12.654a.52.52 0 0 0-.156.386v2.212q0 .23.156.386a.52.52 0 0 0 .386.156.52.52 0 0 0 .386-.156.52.52 0 0 0 .155-.386V13.04a.52.52 0 0 0-.155-.386.52.52 0 0 0-.386-.156.52.52 0 0 0-.386.156" />
    </g>
  </svg>
);
