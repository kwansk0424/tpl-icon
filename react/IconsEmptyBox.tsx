...
const IconsEmptyBox = (
  ...
  >
    ...
    >
      ...
      <path d="M14.687 2.293a.984.984 0 0 0-1.401 0l-3.963 4a1.007 1.007 0 0 0 0 1.414.984.984 0 0 0 1.401 0l3.963-4a1.007 1.007 0 0 0 0-1.414" />
    </g>
  </svg>
);
const ForwardRef = forwardRef(IconsEmptyBox);
